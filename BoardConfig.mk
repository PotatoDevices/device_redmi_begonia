...
#DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest/android.hardware.cas@1.1-service.xml
#DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest/android.hardware.gpu@1.0-service.xml
#DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest/vendor.mediatek.hardware.dplanner@2.0-service.xml
